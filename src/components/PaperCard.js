  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: hovered
          ? '0 12px 40px rgba(0,0,0,0.4), 0 0 20px rgba(99,102,241,0.12)'
    ...
    >
      ...
      <div style={{ paddingLeft: '0.5rem' }}>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.75rem', marginBottom: '0.75rem' }}>
          ...
          {paper.year && (
            <span style={{ display: 'flex', alignItems: 'center', gap: 5, fontSize: '0.8rem', color: '#64748b' }}>
              <FaCalendar size={11} style={{ color: '#10b981' }} />
              {paper.year}
            </span>
          )}
          {paper.citation_count !== undefined && (
            <span style={{ display: 'flex', alignItems: 'center', gap: 5, fontSize: '0.8rem', color: '#64748b' }}>
              <FaQuoteRight size={11} style={{ color: '#f59e0b' }} />
        ...
        <div style={{
          ...
          >
            View details
            <FaArrowRight size={11} style={{ transition: 'transform 0.2s ease' }} />
          </Link>

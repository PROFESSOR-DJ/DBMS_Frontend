      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="card">
              <div className="flex justify-between items-center mb-6">
                ...
                <button onClick={handleEditToggle} className="btn-secondary flex items-center">
                  {editing ? <>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  {editing ? <input type="text" name="name" value={formData.name} onChange={handleChange} className="input-field" /> : <p className="text-gray-900 font-medium">{profile.name}</p>}
                </div>
                ...
                <div>
                  ...
                  <div className="flex items-center">
                    ...
                    {editing ? <input type="email" name="email" value={formData.email} onChange={handleChange} className="input-field" /> : <p className="text-gray-900">{profile.email}</p>}
                  </div>
                </div>
                ...
                {editing && <div className="pt-4 border-t">
          ...
          <div className="space-y-6">
            ...
            {}
            <button onClick={handleLogout} className="w-full bg-red-600 text-white px-4 py-3 rounded-lg font-medium hover:bg-red-700 transition-colors focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2">
              Logout Account
            </button>
          </div>
        </div>

...
const Login = () => {
  ...
  const inputStyle = (name) => ({
    ...
    boxShadow: focused[name]
      ? '0 0 0 3px rgba(99,102,241,0.15), 0 0 20px rgba(99,102,241,0.08)'
      : 'none',
  });
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <p style={{ color: '#64748b', fontSize: '0.9rem' }}>
            Sign in to your <span style={{ color: '#818cf8' }}>ResearchDB</span> account
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
          ...
          <div>
            ...
            <div style={{ position: 'relative' }}>
              <FaEnvelope size={14} style={{ position: 'absolute', left: 12, top: '50%', transform: 'translateY(-50%)', color: focused.email ? '#818cf8' : '#475569', transition: 'color 0.3s ease' }} />
              <input
          ...
          <div>
            ...
            <div style={{ position: 'relative' }}>
              <FaLock size={14} style={{ position: 'absolute', left: 12, top: '50%', transform: 'translateY(-50%)', color: focused.password ? '#818cf8' : '#475569', transition: 'color 0.3s ease' }} />
              <input
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <label style={{ display: 'flex', alignItems: 'center', gap: 8, cursor: 'pointer' }}>
              ...
              <span style={{ fontSize: '0.85rem', color: '#64748b' }}>Remember me</span>
            </label>
            <Link to="/forgot-password" style={{ fontSize: '0.85rem', color: '#818cf8', textDecoration: 'none', fontWeight: 500 }}>
              Forgot password?
            </Link>
          </div>
